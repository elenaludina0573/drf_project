...
from users.services import create_stripe_price, create_stripe_session, create_stripe_product, convert_rub_to_dollars
...
class PaymentCreateAPIView(generics.CreateAPIView):
    ...
    def perform_create(self, serializer):
        ...
        amount_in_doll = convert_rub_to_dollars(payment.payment_amount)
